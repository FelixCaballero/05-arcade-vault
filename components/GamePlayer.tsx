...
export default function GamePlayer({ game }: { game: Game }) {
  ...
  useEffect(() => {
    try {
      const stored: StoredUser | null = JSON.parse(
        localStorage.getItem("av_user") || "null"
      );
      // Deliberate: hydrating client-only session state from localStorage
      // after mount avoids an SSR/client markup mismatch.
